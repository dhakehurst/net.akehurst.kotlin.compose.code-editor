 ...
 * field.
 */
internal class TextLayoutState3 {
    private var layoutCache = TextFieldLayoutStateCache3()
     ...
     * into view (via [TextLayoutState3.bringCursorIntoView]).
     *
...
internal fun TextLayoutState3.fromTextLayoutToCore(offset: Offset): Offset {
 ...
 */
internal fun TextLayoutState3.fromDecorationToTextLayout(offset: Offset): Offset {
...
internal fun TextLayoutState3.fromWindowToDecoration(offset: Offset): Offset {
