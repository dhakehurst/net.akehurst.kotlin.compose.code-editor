...
@file:Suppress("UNUSED", "INVISIBLE_MEMBER", "INVISIBLE_SETTER", "INVISIBLE_REFERENCE", "EQUALS_MISSING", "CANNOT_OVERRIDE_INVISIBLE_MEMBER")
 ...
 */
internal data class TextFieldCoreModifier3(
...
) : ModifierNodeElement<TextFieldCoreModifier3Node>() {

    override fun create(): TextFieldCoreModifier3Node =
        TextFieldCoreModifier3Node(
            isFocused = isFocused,
    ...
    override fun update(node: TextFieldCoreModifier3Node) {
        node.updateNode(
            isFocused = isFocused,
            isDragHovered = isDragHovered,
            textLayoutState = textLayoutState,
...
/** Modifier node for [TextFieldCoreModifier3]. */
internal class TextFieldCoreModifier3Node(
    ...
    private var textFieldState: TransformedTextFieldState3,
    private var textFieldSelectionState: TextFieldSelectionState3,
