...
import androidx.compose.foundation.gestures.coroutineStartForCurrentDispatchBehavior
import androidx.compose.foundation.gestures.detectDragGestures
import androidx.compose.foundation.gestures.detectTapAndPress
import androidx.compose.foundation.gestures.detectTapGestures
import androidx.compose.foundation.gestures.launchAwaitingReset
...
import androidx.compose.foundation.text.input.internal.selection.detectPressDownGesture
 ...
 *
 * @param textFieldState The [TransformedTextFieldState3] associated with this text field.
...
internal class TextFieldSelectionState3(
...
*/
     ...
     * into account text transformations ([TransformedTextFieldState3]) to avoid putting the cursor
...
/**
 * Creates a menu item action callback for a [TextFieldSelectionState3].
 *
 ...
 * @receiver The [TextFieldSelectionState3] representing the current selection state of a text field
 *   for which the menu item is being created.
 */
internal inline fun TextFieldSelectionState3.menuItem(
    enabled: Boolean,
...
private const val DEBUG_TAG = "TextFieldSelectionState3"
...
internal interface TextToolbarHandler {
    ...
    /**
     * @param selectionState - [TextFieldSelectionState3] of the text field for which the
     ...
     */
    suspend fun showTextToolbar(selectionState: TextFieldSelectionState3, rect: Rect)
