...
fun TextLayoutResult.MygetLineForVerticalPosition(vertical: Float): Int =
    multiParagraph.MygetLineForVerticalPosition(vertical)


fun MultiParagraph.MygetLineForVerticalPosition(vertical: Float): Int {
